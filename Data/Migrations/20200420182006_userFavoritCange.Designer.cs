...
namespace alphadinCore.Data.Migrations
{
    ...
    [Migration("20200420182006_userFavoritCange")]
    partial class userFavoritCange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("alphadinCore.Model.dbModels.GeneralTypesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("alphadinCore.Model.dbModels.SchoolCourseModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("SchoolTopicModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SchoolTopicModelId");

                    b.ToTable("SchoolCourses");
                });

            modelBuilder.Entity("alphadinCore.Model.dbModels.SchoolQuisQuestionOptionModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("SchoolQuizQuestionModelId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("SchoolQuizQuestionModelId");

                    b.ToTable("SchoolQuisQuestionOptions");
                });

            modelBuilder.Entity("alphadinCore.Model.dbModels.SchoolQuizCourseModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("SchoolCourseModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SchoolCourseModelId");

                    b.ToTable("SchoolQuizCourses");
                });

            modelBuilder.Entity("alphadinCore.Model.dbModels.SchoolQuizQuestionModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("alphadinCore.Model.dbModels.SchoolTopicModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("alphadinCore.Model.dbModels.SchoolUnitModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("alphadinCore.Model.dbModels.UserSocialsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("alphadinCore.Model.UserFavoriteModel", b =>
                {
                    b.HasOne("alphadinCore.Model.dbModels.FavoriteTagModel", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId");
            ...
            modelBuilder.Entity("alphadinCore.Model.dbModels.SchoolCourseModel", b =>
                {
                    b.HasOne("alphadinCore.Model.dbModels.SchoolTopicModel", null)
                        .WithMany("Courses")
                        .HasForeignKey("SchoolTopicModelId");
                });

            modelBuilder.Entity("alphadinCore.Model.dbModels.SchoolQuisQuestionOptionModel", b =>
                {
                    b.HasOne("alphadinCore.Model.dbModels.SchoolQuizQuestionModel", null)
                        .WithMany("Options")
                        .HasForeignKey("SchoolQuizQuestionModelId");
                });

            modelBuilder.Entity("alphadinCore.Model.dbModels.SchoolQuizCourseModel", b =>
                {
                    b.HasOne("alphadinCore.Model.dbModels.SchoolQuizQuestionModel", "Question")
                        .WithMany()
                        .HasForeignKey("QuestionId");

                    b.HasOne("alphadinCore.Model.dbModels.SchoolCourseModel", null)
                        .WithMany("Questions")
                        .HasForeignKey("SchoolCourseModelId");
                });
